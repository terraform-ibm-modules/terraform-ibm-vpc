...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/vpc/ibm/latest)
...
<ul>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpc/tree/main/examples">Examples</a>
    <ul>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-vpc/tree/main/examples/load-balancer">Load balancer example</a>
        <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=vpc-load-balancer-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-vpc/tree/main/examples/load-balancer"><img src="https://img.shields.io/badge/Deploy%20with%20IBM%20Cloud%20Schematics-0f62fe?style=flat&logo=ibm&logoColor=white&labelColor=0f62fe" alt="Deploy with IBM Cloud Schematics" style="height: 16px; vertical-align: text-bottom; margin-left: 5px;"></a>
      </li>
    </ul>
